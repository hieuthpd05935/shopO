...
import ProductTable from './BrandList';
import ModalCreate from './ModalCreate';
import { getListBrands } from './httpClient';
...
const Home = () => {
  ...
  const { isFetching } = useQuery({
    ...
    queryFn: ({ queryKey }) => getListBrands(_.omit(queryKey[1] as { [key: string]: any }, 'validate')),
  ...
  return (
    <div>
      ...
      <ProductTable
        ...
        headerRows={['Name', 'Deleted date', 'Updated date', 'Actions']}
      />
    </div>
  );
};
