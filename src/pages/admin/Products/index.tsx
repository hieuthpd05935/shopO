...
import { Component as ModalCreate } from './ModalCreate';
import ProductTable from './ProductList';
import { getListProduct } from './httpClient';
...
const ProductComponent = () => {
  ...
  const { isFetching } = useQuery({
    ...
    queryFn: ({ queryKey }) => getListProduct(_.omit(queryKey[1] as { [key: string]: any }, 'validate')),
  ...
  return (
    <div>
      ...
      <ProductTable
        ...
        headerRows={['Name', 'Price', 'Brand', 'Category', 'Sold', 'Total Comment', 'Actions']}
      />
    </div>
  );
};
...
export const Component = ProductComponent;
